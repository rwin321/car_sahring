    ...
    <Container>
      ...
      <StepsContainer>
        <StepContainer>
          ...
          <StepDescription>Find the nearest Smartcar point and book your car</StepDescription>
        </StepContainer>
        <StepContainer>
          <Step>
            <StepIcon>
        ...
        <StepContainer>
          ...
          <StepDescription>Book your nice car with ease in one click</StepDescription>
        </StepContainer>
      </StepsContainer>
    </Container>
  )
